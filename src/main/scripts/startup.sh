...
${java.path}java -server -Xms256M -Xmx512M -Xss512k \
...
-XX:+UseG1GC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp/${project.artifactId}.dump  \
-XX:MaxGCPauseMillis=200ms -XX:G1HeapRegionSize=16m -XX:+PrintGCDetails -XX:+PrintHeapAtGC -Xloggc:/tmp/${project.artifactId}.gc
-Djava.awt.headless=true -Dspring.profiles.active=${param} -jar \
